...
namespace Scern\Lira\Component\Front\Contacts;
...
class Contacts extends Controller
{
    ...
    {
        $this->view->seo->title = 'Contacts | SCERN';
        $view = new View($this->lexicon);
        //$view->article = $this->model->getArticleById(1,$this->lexicon->currentLang);
        return new Success($view->render(ROOT_DIR . DS . 'component' . DS . 'Front' . DS . 'Contacts' . DS . 'template.inc'));
    }
}